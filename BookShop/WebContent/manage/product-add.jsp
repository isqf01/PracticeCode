...
function check3()
{
	...
	var reg = /^[0-9]*$/; <%--正则表达式判断是否为数字--%>
	var num2 = new RegExp(reg)
	
	if(!num2.test(num)){	<%--判断是否为纯数值--%>
		alert("请输入纯数值");
		<%--document.getElementById("yy").innerHTML="<font color='red'>价格请输入数值</font>";	--%>
		return false;
	}else{
		return true;
	}
...
<div id="header" class="wrap">
	<div id="logo"><img src="../images/logo.gif" width="60px" height="60px"/></div>
...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加商品</h2>
		<div class="manage">
			<form action="doProductAdd" method="post" enctype="multipart/form-data" onSubmit="return check3()">
				<table class="form">
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="text tiny" name="productPrice"  id="y"/> 元(整数)</td>
					</tr>
					<tr>
